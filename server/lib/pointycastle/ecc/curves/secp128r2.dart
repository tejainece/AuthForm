...
import "../../src/ec_standard_curve_constructor.dart";

class ECCurve_secp128r2 extends ECDomainParametersImpl {

  static final FactoryConfig FACTORY_CONFIG =
  new StaticFactoryConfig(ECDomainParameters, "secp128r2");
  ...
  factory ECCurve_secp128r2() => constructFpStandardCurve("secp128r2",
    ...
    g: BigInt.parse("047b6aa5d85e572983e6fb32a7cdebc14027b6916a894d3aee7106fe805fc34b44", radix: 16),
    n: BigInt.parse("3fffffff7fffffffbe0024720613b5a3", radix: 16),
    h: BigInt.parse("4", radix: 16),
    seed: BigInt.parse("004d696e67687561517512d8f03431fce63b88f4", radix: 16)
  );
